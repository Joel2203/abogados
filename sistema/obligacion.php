...
<div id="sidebar" class="sidebar">
    ...
    <div class="container mt-5">
      <div class="table-responsive">
        ...
        <table class="table table-bordered text-center">
            <thead>
              <tr>
                  <th>INTERPRETACION (EXPLICACIÓN DE LA OBLIGACIÓN)</th>
                  <th>Fuente (Instrumento de gestión ambiental / Normas)</th>
    ...
    <script>
      ...
      fetch(
        "https://spijwsii.minjus.gob.pe/spij-ext-back/api/procesarword/"+resultado.id
      )
